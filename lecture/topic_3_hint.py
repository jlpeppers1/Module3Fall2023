...
# Get a starting price: hardcode a price or get from user input; set to a variable (Mod 1 and 2 we got user input)
#part or step 1
    #if cash_coupon then
        #if it is 5$
            #do calculation
    ...
    #add a print statement here while you are working on it for debugging
## Stop at this point, test and get above working
#part or step 2
    #if percent_coupon then
        #do calculation per percent off
    #set a post percent coupon total variable (Discount % amt)
### Stop at this point, test and get above working
#Third step is to do tax; you can pick a tax rate
    #set to a subtotal
#### Stop at this point, test and get above working
#Fourth is shipping (sequential if statements)
